!function snoovararInit(window, r, $, _, paper) {
  ...
  // config values
  var imagePath = '//www.reddit.com/static/snoovatar/images/';
  var canvasSize = 400;
  var pixelRatio = 2;
...
r.snoovatar.initTailors([{
    ...
    asset_path: "grippables",
    allow_clear: !0,
    name: "flipped_grippables",
    dressings: [{
        name: "airhorn"
    }, {
